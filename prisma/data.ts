...
export const documentData = [
  {
    ...
    body: `ここでは一般的な定義にならい，生産性を「最小限の投資で最大限の事業成果を生み出すこと」と定義する．また志望企業を「SaaSを提供するソフトウェア企業」とし，募集ポジションをソフトウェア開発職とする．以下，生産性向上のために，AIよりも私が貢献できる点について述べる．
...
上記の二点より，企業の生産性向上には，AIよりも私のほうが貢献できると考える．`,
  ...
  },
  {
    ...
    body: `若年層がSNSを使う時間は制限すべきだと考える．
なぜなら，SNSを長時間利用して得られるメリットがデメリットよりも小さいからである．SNSを利用することで，世の中の情報をリアルタイムに得ることができる．最新の情報が必要な人にとって，これはSNSを利用する大きな理由となる．
一方で，一般的なSNSは誰でも投稿できるため，情報の質は低いものが多い．フェイクニュースも問題となっている昨今で，質の高い情報をSNSから得ることは年々難しくなってきている．SNS上では，いいねやリツイートなどの他者からの承認が重視されており，良質な情報を発信することが必ずしもそれらにつながらない．
言い換えるならば，良質な情報発信を行う利点が，他のメディアと比較して相対的に小さいと考えられる．
